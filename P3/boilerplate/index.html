...
<body>
  ...
  <section class="hero">
    <div class="intro-text">
      ...
      <p>Uma plataforma de streaming de games.<br>com momentos especiais com games nostálgicos</p>
      <a class="btn purple" href="#">saiba mais</a>
      <a class="btn grey" href="#">assinar</a>
    </div>
    <div class="i-frame">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/4TOycLs_7oE" title="YouTube video player"
      frameborder="10"
  ...
  <section class="about" id="about">
    <h3>Assista as transmissôes</h3>
    <p>transmissôes 24/7, nunca fique sem diversão</p>
    <h3>Somente os melhores</h3>
    <p>Assista os melhores streamers do Brasil em um só local</p>
  </section>
 ...
 <!-- Lightbox image gallery -->
  ...
  <i class="scroll-up" id="scroll-up">
    <img src="assets/icons/upward-arrow.png" class="socicon up-arrow"alt="up-arrow" />
  </i>
